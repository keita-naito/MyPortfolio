...
@section('content')
    <div class="reservation-page">
        ...
        <div class="reservation-wrapper">
            <iframe class="reservation-calendar" src="https://calendar.google.com/calendar/embed?src=etl9g7pdqok7ujkc4v3g35l8co%40group.calendar.google.com&ctz=Asia%2FTokyo" style="border: 0" width="50%" height="600" frameborder="0" scrolling="no"></iframe>
